...
from entity.starhip import Starhip
...
class StarWarsApi:
    ...
    def get_entity(self, entity, entity_id):
        ...
        if response.status_code == 200:
            ...
            raise ValueError(f'Неможливо отримати дані для сутності {entity} з індитифікатором {entity_id}')
    ...
    def get_starhip(self, starhip_id):
        starhip_dict = self.get_entity('starships', starhip_id)
        return Starhip(starhip_dict)
